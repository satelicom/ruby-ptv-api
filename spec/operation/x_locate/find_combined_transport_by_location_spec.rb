...
describe SatelicomPtv::Operation::XLocate::FindCombinedTransportByLocation do
  let(:location){ create(:location) }
  
  it 'call' do
    VCR.use_cassette("find_combined_transport_by_location") do
      function = SatelicomPtv::Operation::XLocate::FindCombinedTransportByLocation.new(location)
